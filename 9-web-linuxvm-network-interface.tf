resource "azurerm_public_ip" "web_host_publicip" {
  name                = "${local.resource_name_prefix}-web-host-publicip"
...
resource "azurerm_network_interface" "web_linuxvm_nic" {
  ...
  ip_configuration {
    ...
    public_ip_address_id           = azurerm_public_ip.web_host_publicip.id
  }
}
